...
from berkie_reachy.vision.processors import (
    VisionConfig,
    VisionManager,
    VisionProcessor,
...
def mock_torch() -> Any:
    ...
    with patch("berkie_reachy.vision.processors.torch") as mock:
...
def mock_transformers() -> Any:
    ...
    with patch("berkie_reachy.vision.processors.AutoProcessor") as proc, \
         patch("berkie_reachy.vision.processors.AutoModelForImageTextToText") as model:
...
def test_vision_processor_initialization_failure(mock_torch: Any) -> None:
    ...
    with patch("berkie_reachy.vision.processors.AutoProcessor") as mock_proc:
...
def test_vision_processor_process_image_success(mock_torch: Any, mock_transformers: Any) -> None:
    ...
    with patch("berkie_reachy.vision.processors.cv2") as mock_cv2:
...
def test_initialize_vision_manager_success(mock_torch: Any, mock_transformers: Any, mock_camera: Mock) -> None:
    ...
    with patch("berkie_reachy.vision.processors.snapshot_download") as mock_download, \
         patch("berkie_reachy.vision.processors.os.makedirs"), \
         patch("berkie_reachy.vision.processors.config") as mock_config:
...
def test_initialize_vision_manager_processor_failure(mock_torch: Any, mock_camera: Mock) -> None:
    ...
    with patch("berkie_reachy.vision.processors.snapshot_download"), \
         patch("berkie_reachy.vision.processors.os.makedirs"), \
         patch("berkie_reachy.vision.processors.config") as mock_config, \
         patch("berkie_reachy.vision.processors.AutoProcessor") as mock_proc:
