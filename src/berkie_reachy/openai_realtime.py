...
from berkie_reachy.prompts import get_session_voice, get_session_instructions
from berkie_reachy.tools.core_tools import (
    ToolDependencies,
    get_tool_specs,
)
from berkie_reachy.tools.background_tool_manager import (
    ToolCallRoutine,
    ToolNotification,
...
class OpenaiRealtimeHandler(AsyncStreamHandler):
    ...
    async def apply_personality(self, profile: str | None) -> str:
        ...
        try:
            ...
            from berkie_reachy.config import config as _config
            from berkie_reachy.config import set_custom_profile
