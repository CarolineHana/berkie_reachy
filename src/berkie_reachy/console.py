...
from berkie_reachy.config import LOCKED_PROFILE, config
from berkie_reachy.openai_realtime import OpenaiRealtimeHandler
from berkie_reachy.headless_personality_ui import mount_personality_routes
...
class LocalStream:
    ...
    def _init_settings_ui_if_needed(self) -> None:
        ...
        def _ready() -> JSONResponse:
            try:
                mod = sys.modules.get("berkie_reachy.tools.core_tools")
