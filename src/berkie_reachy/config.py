...
LOCKED_PROFILE: str | None = "_berkie_reachy_locked_profile"
...
class Config:
    ...
    # CONVERSATION_ID/USERNAME/PASSWORD/passcode are per-account credentials and are
    # never hardcoded here - this file is committed to a public repo. Supply them via
    # this device's own .env (persisted by the settings-page form, see console.py's
    # /berky_connection routes) rather than editing this file.
